...
# ALBUM
# ====================================
magic = justin_bieber.albums.create(title: "24K Magic")

magic_cover = open('https://jamify-data.s3.amazonaws.com/album_covers/Bruno+Mars/24k_magic.jpeg')
magic.cover_image.attach(io: magic_cover, filename: 'magic.jpeg')
magic.save!
...
believe1 = believe.songs.create(
    title: "All In It",
    genre_id: believe.genre.id,
    duration: "4:26",
    artist_id: justin_bieber.id
)
...
believe3_url = open("https://jamify-data.s3.amazonaws.com/audio_files/Justin+Bieber/Believe/Justin+Bieber+-+What+Do+You+Mean+(Clean).mp3")
